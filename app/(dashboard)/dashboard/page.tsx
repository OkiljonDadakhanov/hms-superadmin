    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{activityOverview?.appointments || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{activityOverview?.newPatients || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{activityOverview?.medicinesSold || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{activityOverview?.labTests || 0}</div>
                ...
                <div key={content.id} className="flex items-center justify-between py-2">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">By {content.author}</div>
                    </div>
                  </div>
                  <Button variant="outline" size="sm" onClick={() => handleAssignContent(content.id)}>
                    Assign
                  </Button>
                </div>
              ))}
          ...
          <CardContent>
            <div className="space-y-4">
              {patientFees.map((fee) => {
                ...
                return (
                  <div key={fee.patientId} className="flex items-center justify-between py-2">
                    <div className="flex items-center space-x-3">
                      <Avatar className="h-8 w-8">
                        <AvatarImage src={patient?.avatar} />
                        <AvatarFallback>{patient?.name?.charAt(0)}</AvatarFallback>
                      ...
                      <div>
                        <div className="font-medium">{patient?.name}</div>
                        <div className="text-xs text-gray-500">
                          {fee.status === "pending" ? "Payment pending" : "Payment completed"}
                        </div>
                      </div>
                    </div>
                    <Button
